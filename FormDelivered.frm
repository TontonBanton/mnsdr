...
Begin VB.Form FormDelivered 
   ...
   Begin VB.Image Image1 
      Height          =   720
      Left            =   120
      Picture         =   "FormDelivered.frx":0000
      Stretch         =   -1  'True
      Top             =   50
      Width           =   780
   End
   ...
   End If
      If EncodeMode = "A" Then
         ...
         strsql = strsql & ")"
          ...
          Set mmsNewListItem = lvwDelivered.ListItems.Add(, , txtCustomer.Text)
      ...
      ElseIf EncodeMode = "U" Or EncodeMode = "S" Then 'Update
         lngIDField = lvwDelivered.SelectedItem.SubItems(1)
         ...
         lvwDelivered.SelectedItem.Text = txtCustomer.Text
...
Private Sub SetlvwDelivered()
    With lvwDelivered
        ...
        .ColumnHeaders.Add , , "Adress", .Width * 0.32
        .ColumnHeaders.Add , , "Contact", .Width * 0.32
...
Private Sub LoadDelivered()
    ...
    strsql = "SELECT * From Delivered Order By Customer"
    mmsAdoCmd.CommandText = strsql
    Set mmsADORst = mmsAdoCmd.Execute
    LVDelivered
              With lvwDelivered
...
lvwDelivered.ListItems.Clear
    With mmsADORst
        Do Until .EOF
            Set DeliveredLI = lvwDelivered.ListItems.Add(, , !Customer & "")
                DeliveredLI.SubItems(3) = !DeliveredID
                .MoveNext
        Loop
     End With
...
Private Function DataValidation() As Boolean
  DataValidation = False
    If txtCustomer.Text = "" Then
         MsgBox "Fill-up Name", vbExclamation, "NameRequired"
         txtCustomer.SetFocus
        Exit Function
    End If
