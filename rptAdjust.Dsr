VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ReportAdjust 
   Bindings        =   "rptAdjust.dsx":0000
   Caption         =   "PRINT ADJUSTMENT"
   ClientHeight    =   10950
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10395
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "A  D  J  U  S  M  E  N  T     S  L  I  P"
      EndProperty
   EndProperty
   SectionCode2    =   4
   ...
   BeginProperty Section3 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item4 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "ALL RIGHTS RESEVED"
         Alignment       =   2
      EndProperty
      ItemType5       =   3
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
   ...
   EndProperty
End
Attribute VB_Name = "ReportAdjust"
...
Private Sub DataReport_Initialize()
  ...
  ReportAdjust.Refresh
  If ReportAdjust.Visible = False Then ReportAdjust.Show
  ReportAdjust.Sections("ReportHeader").Controls("lblLocation").Caption = FormSettings.txtLocation.Text
  ReportAdjust.Sections("ReportHeader").Controls("lblComp").Caption = FormSettings.txtComp.Text
  ReportAdjust.Sections("ReportHeader").Controls("lblNow").Caption = Format(Date, "mmm-dd-yyyy")
  ReportAdjust.Sections("PageFooter").Controls("lblPrepared").Caption = FormSettings.txtPrepared.Text
  ReportAdjust.Sections("PageFooter").Controls("lblApproved").Caption = FormSettings.txtApproved.Text
End Sub
Private Sub DataReport_Terminate()
  'FormMIS.Show
  'FormMIS.cmdPrint.Enabled = False
  'FormMIS.cmdCancel.Enabled = False
  'FormMIS.cmdDelete.Enabled = False
  'FormMIS.cmdExit.SetFocus
End Sub
